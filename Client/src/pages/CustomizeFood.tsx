              ...
              <div className="flex flex-wrap gap-2">
                {["Mild", "Medium", "Spicy", "Extra Spicy"].map((level) => (
                  <button
                    ...
                    className={`px-3 py-1 sm:px-4 sm:py-2 rounded-md text-sm font-semibold transition ${formData.spiceLevel === level ? "bg-orange-500 text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300"
                      }`}
                  >
                    {level}
                  </button>
              ...
              <div className="flex flex-wrap gap-2">
                {["Grilled", "Fried", "Boiled", "Baked", "N/A"].map((method) => (
                  <button
                    ...
                    className={`px-3 py-1 sm:px-4 sm:py-2 rounded-md text-sm font-semibold transition ${formData.cookingMethod === method ? "bg-orange-500 text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300"
                      }`}
                  >
                    {method}
                  </button>
              ...
              <div className="flex flex-wrap gap-2">
                {["Single", "Family", "Party Size"].map((size) => (
                  <button
                    ...
                    className={`px-3 py-1 sm:px-4 sm:py-2 rounded-md text-sm font-semibold transition ${formData.servingSize === size ? "bg-orange-500 text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300"
                      }`}
                  >
                    {size}
                  </button>
