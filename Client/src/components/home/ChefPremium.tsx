...
const plans = [
  ...
  },
  {
    ...
    price: 1750,
    duration: "Per Month",
    features: ["All Basic Benefits", "30 Menus can Be uploaded", "AI Chatbot Support"],
  },
  {
    displayName: "Yearly",
    internalName: "Pro",
      ...
      {plans.map((plan, index) => (
        ...
        >
          ...
          <div className="mt-6 text-center">
            ...
            <button 
              onClick={() => {
                handleCheckout(plan.internalName, plan.price, "menuupload");
